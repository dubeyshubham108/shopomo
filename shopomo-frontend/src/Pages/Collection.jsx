    ...
    return (
        <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t">
            <div className="min-w-60">
                ...
                <div className={`border border-grayy-300 pl-5 py-3 my-5 ${showFilter ? '' : 'hidden'} sm:block`}>
                ...
                <div className={`border border-grayy-300 pl-5 py-3 mt-6 ${showFilter ? '' : 'hidden'} sm:block`}>
